...
const UserPanel: FC = () => {
    return (
        <div className={"user-panel"}>
            ...
            <Link to={"orders-history"} className="order-history user-panel__item">История заказов</Link>
            <Link to={"services-history"} className="service-history user-panel__item">История услуг</Link>
            <Link to={"cart"} className="cart user-panel__item">
                <div className="count">
                    <span>10</span>
                </div>
                <span>Корзина</span>
